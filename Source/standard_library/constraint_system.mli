...
constraints of [csys]. *)
val add_new_dependency_constraint : constraint_system -> Recipe.variable list -> Recipe.axiom list -> constraint_system
...
val get_dependency_constraints : constraint_system -> (Recipe.variable list * Recipe.axiom list) list
